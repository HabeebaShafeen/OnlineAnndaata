...
@WebServlet("/ProfileEdit_Farmer")
public class ProfileEdit_Farmer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "update farmer_details set name = ?, phoneNo = ?, location =?, password =? where aadhar = ?";
